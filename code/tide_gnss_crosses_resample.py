...
# =============================================================================
# =============================================================================
for buffer_size in [10,20,30,40,50,60]:
# =============================================================================
# =============================================================================
    ...
    repeated.drop(['time_ele','intx_points'],1).to_file(f'/Users/home/whitefar/DATA/FIELD_ANT_19/POST_FIELD/INTERSECTIONS/tides_10msample_{buffer_size}mbuffer.shp')
    repeated.to_pickle(f'/Users/home/whitefar/DATA/FIELD_ANT_19/POST_FIELD/INTERSECTIONS/tides_10msample_{buffer_size}mbuffer.pkl')
