...
for i in tqdm(range(0,rs.shape[0])):
    ...
    intx = rs[ (rs.geometry.intersects(rs.iloc[i].geometry.buffer(20)) == True) #the 8 is 8m away
...
repeated['max_dh'] =  repeated.time_ele.apply(max_dh_f)
...
repeated.drop(['time_ele','intx_points'],1).to_file('/Users/home/whitefar/DATA/FIELD_ANT_19/POST_FIELD/INTERSECTIONS/tides_10msample20mcluster.shp')
repeated.to_pickle('/Users/home/whitefar/DATA/FIELD_ANT_19/POST_FIELD/INTERSECTIONS/tides_10msample20mcluster.pkl')
  
# # =============================================================================
# =============================================================================
      
plt.plot(repeated.Longitude,repeated.tide,'x')
plt.show()