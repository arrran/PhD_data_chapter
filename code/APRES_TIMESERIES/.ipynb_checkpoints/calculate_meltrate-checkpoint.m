...
meta = readtable('/Users/home/whitefar/DATA/APRES_TIMESERIES/kis2_apres_timeseries_meta.csv');
...
for i = 1:height(meta)
    ...
    f = string(meta.File_Name1(i));
    g = string(meta.File_Name2(i));
    ...
    data.Approx_Depth(i+1) = data_out.bed.range
