...
% Default configuration file for fmcw_process Langhovde BH2-2
%
...
% phase-processing
cfg.p = 6; % padfactor (interpolation factor gi generating profile)
% note: higher pad factor increases the likelihood of estimating the
% correct bin  lag.
cfg.maxRange = 300; % maximum bed range
cfg.winFun = @blackman;
...
cfg.firnDepth = 130; % used to select depth range for vertical strain estimate
