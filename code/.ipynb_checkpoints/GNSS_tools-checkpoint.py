...
input_files = f"/Users/home/whitefar/Documents/Stuff/GNSS_buck/wgtn_airport_ppp_data/*.20O"

#Sample filename = KIS1352a.19_

output_file_location = "/Users/home/whitefar/Documents/Stuff/GNSS_buck/rinex_files/wgtn_airport/"

gpsinterval = 1 # GPS sampling interval in secs
antenna_height = 0.055 # in metres
...
for i,filename in enumerate(filenames):
    ...
    time_in_capitals = 65
    time_in_lowercase = 97   
    time = dt.time(ord(filename[7])-time_in_capitals)# change this to capitals or lowercase var #this is weird because the time is given as a letter ie a = 00:00-01:00 b = next hour
